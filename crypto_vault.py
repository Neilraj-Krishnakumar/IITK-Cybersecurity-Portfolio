...
def execute_crypto_vault():
    ...
    while total_blocks_encrypted < 5:
        ...
        print("VAULT ENGINE TRANSACTION: RECORD LAYER " + str(total_blocks_encrypted) + "AT" + system_timestamp)
    ...
    print("Total system segments safely locked: " + str(total_blocks_encrypted))
